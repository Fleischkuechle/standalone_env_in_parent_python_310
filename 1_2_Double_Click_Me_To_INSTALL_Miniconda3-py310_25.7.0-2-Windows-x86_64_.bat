...
set MINICONDA_DOWNLOAD_URL=https://repo.anaconda.com/miniconda/Miniconda3-py310_25.7.0-2-Windows-x86_64.exe
set MINICONDA_CHECKSUM=3f5b24e9873bf12a72b7a639e7d59d3cc1015f4cd552dbaf981cc0518be271ed
set conda_exists=F
